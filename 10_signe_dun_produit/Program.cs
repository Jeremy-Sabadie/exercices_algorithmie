    ...
    internal class Program
    {
        static void Main(string[] args)
        {
           ...
           int Nb1= int.Parse(Console.ReadLine());//Un premier nombre est attendu.
            ...
            {
                Console.WriteLine("la somme des deux nombre est positive.");//On indique que la somme des deux variable est positive.
            ...
            {
                Console.WriteLine("la somme des deux nombre est négative.");//On indique que la somme des deux variable est négative.
            }
            Console.ReadLine();
